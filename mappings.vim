...
nmap <space>O O<Esc>| " Insert line below and stay normal mode.
nmap <expr> <space>m ":'" . input("Marker: ") . "<Enter>"| " Move to the mark specified after :'
...
nmap <space>cmt 0i#<Esc>| " Comment the current line
...
nmap <space>uct 0x| " Uncomment the current line
